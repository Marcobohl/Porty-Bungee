        ...
        if (timer <= 0) {
            ...
            timerCallback.setRunnable(new CallbackRunnable() {
                ...
                public void error(String errmsg) {
                    ...
                    player.sendMessage(TextComponent.fromLegacyText(BasePortyCommand.PREFIX_MAIN + Messages.getMessage("timer_fail", "&7You moved")));
                }
            });
        }
